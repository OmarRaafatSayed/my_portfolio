...
export function HeroSection() {
  ...
  const titles = ["Business Developer", "Speaker"]
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 bg-background">
      ...
      <motion.div className="relative z-10 text-center max-w-5xl mx-auto" style={{ opacity }}>
        ...
        >
          I help companies grow by opening new markets, building strategic partnerships, and driving business development initiatives that turn opportunities into long-term results.
        </motion.p>
        ...
        >
          ...
          <button
            ...
            className="group w-full sm:w-auto inline-flex justify-center items-center gap-3 shadow-xl text-lg bg-background text-foreground font-semibold isolation-auto border-primary before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-primary hover:text-primary-foreground before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden relative z-10 h-12 px-6 border-2 rounded-full whitespace-nowrap"
          >
            Let's Achieve Your Vision
            <svg className="w-8 h-8 shrink-0 group-hover:rotate-90 group-hover:bg-background text-foreground ease-linear duration-300 rounded-full border border-current group-hover:border-primary-foreground p-2 rotate-45" viewBox="0 0 16 19" xmlns="http://www.w3.org/2000/svg">
